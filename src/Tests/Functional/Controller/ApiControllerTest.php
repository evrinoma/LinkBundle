...
namespace Evrinoma\LinkBundle\Tests\Functional\Controller;

use Evrinoma\LinkBundle\Fixtures\FixtureInterface;
...
{
    protected string $actionServiceName = 'evrinoma.link.test.functional.action.link';
    ...
    {
        return [FixtureInterface::LINK_FIXTURES];
    }
}
